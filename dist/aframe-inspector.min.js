  ...
  var e,
    ...
    n = {
          ...
          (this.setAspectRatio = function (e) {
            ...
            (this.dispose = function () {
              t.removeEventListener('contextmenu', C, !1),
                ...
                t.removeEventListener('wheel', b, !1),
                t.removeEventListener('mousemove', y, !1),
                t.removeEventListener('mouseup', A, !1),
                t.removeEventListener('mouseout', A, !1),
                t.removeEventListener('dblclick', A, !1),
                    ...
                    if (!1 !== t) {
                      if (
                        ...
                        m.sub(g),
                          ...
                          'local' === r.space &&
                            ('XYZ' === r.axis
                              ? ((A = 1 + m.y / Math.max(z.x, z.y, z.z)),
                                (r.object.scale.x = z.x * A),
                                (r.object.scale.y = z.y * A),
                                (r.object.scale.z = z.z * A))
                              : (m.applyMatrix4(x.copy(H).invert()),
                                'X' === r.axis &&
                                  (r.object.scale.x = z.x * (1 + m.x / z.x)),
                                'Y' === r.axis &&
                                  (r.object.scale.y = z.y * (1 + m.y / z.y)),
                                'Z' === r.axis &&
                                  (r.object.scale.z = z.z * (1 + m.z / z.z))));
                      else if ('rotate' === o)
                        if (
                          (m.sub(F),
                          m.multiply(D),
                          ...
                          m.applyMatrix4(x.copy(b).invert()),
                            E.applyMatrix4(x.copy(b).invert()),
                            v.set(
                              Math.atan2(m.z, m.y),
                              Math.atan2(m.x, m.z),
                              Math.atan2(m.y, m.x)
                ...
                (this.setCamera = function (e) {
                  ...
                  (this.update = function (e) {
                    void 0 !== r.object &&
                      ...
                      (A = (F.distanceTo(U) / 6) * r.size),
                      this.position.copy(F),
                      e && this.scale.set(A, A, A),
      ...
      253: (e, t, n) => {
        ...
        var r = n(324);
        const o = {};
        r.A.on('entityupdate', (e) => {
          let t = e.value;
          const n = e.entity;
          o[n.id] = o[n.id] || {};
          const r = AFRAME.components[e.component];
          r &&
            (e.property
        ...
        e.exports = function (e, t, n) {
          ...
          function x() {
            ...
            if (((r = arguments), (o = this), (l = e), n)) {
              if (void 0 === s)
                return (function (e) {
                  return (c = e), (s = setTimeout(b, t)), u ? y(e) : a;
                })(l);
              if (p) return (s = setTimeout(b, t)), y(l);
            }
      ...
      551: (e, t, n) => {
        ...
        function He(e, t, n, r, o, i, a, s, l) {
          (Pe = !1), (Be = null), ze.apply(_e, arguments);
        }
        function Ue(e) {
          var t = e,
            n = e;
            ...
            if (null === o) Wr(e, t, r, Gt, n), zt(e, r);
              ...
              (function (e, t, n, r, o) {
                switch (t) {
                  ...
                  case 'dragenter':
                    return (It = Pt(It, e, t, n, r, o)), !0;
                  case 'mouseover':
                    return (Rt = Pt(Rt, e, t, n, r, o)), !0;
                  case 'pointerover':
                    var i = o.pointerId;
                  ...
                  case 'gotpointercapture':
                    return (
                      (i = o.pointerId),
                      Nt.set(i, Pt(Nt.get(i) || null, e, t, n, r, o)),
                      !0
                    );
                }
                return !1;
        ...
        var Pn = u && 'TextEvent' in window && !zn,
          Bn = u && (!jn || (zn && 8 < zn && 11 >= zn)),
          ...
          Oe(function () {
            ...
            if (0 == (7 & t)) {
              ...
              A &&
                (Bn &&
                  'ko' !== n.locale &&
                  (Un || 'onCompositionStart' !== A
                    ? 'onCompositionEnd' === A && Un && (y = en())
        ...
        var Ui = {
          ...
          enqueueSetState: function (e, t, n) {
            ...
            (i.payload = t),
              null != n && (i.callback = n),
              null !== (t = zi(e, i, o)) && (rc(t, e, o, r), Pi(t, e, o));
          },
          ...
          enqueueForceUpdate: function (e, t) {
            ...
            (o.tag = 2),
              null != t && (o.callback = t),
              null !== (t = zi(e, o, r)) && (rc(t, e, r, n), Pi(t, e, r));
          }
        };
        ...
        function Xi(e) {
          ...
          function c(e, t, n, r) {
            ...
            return i === E
              ...
              : null !== t &&
                ...
                : (((r = zc(n.type, n.key, n.props, null, e.mode, r)).ref = $i(
                    e,
                    t,
                    n
                  )),
          ...
          function d(e, t, n) {
            ...
            if ('object' == typeof t && null !== t) {
              switch (t.$$typeof) {
                case C:
                  return (
                    ((n = zc(t.type, t.key, t.props, null, e.mode, n)).ref = $i(
                      e,
                      null,
                      t
                    )),
          ...
          function f(e, t, n, r) {
            ...
            if ('object' == typeof n && null !== n) {
              ...
              if (te(n) || z(n)) return null !== o ? null : p(e, t, n, r, null);
              Gi(e, n);
            }
            return null;
          }
              ...
              switch (a.$$typeof) {
                case C:
                  e: {
                    ...
                    a.type === E
                      ? (((i = Pc(a.props.children, r.mode, l, a.key)).return =
                          r),
                        (r = i))
                      : (((l = zc(
                          a.type,
        ...
        function ja(e, t, n, r) {
          (t.value = n), (t.getSnapshot = r), Pa(t) && Ba(e);
        }
        function za(e, t, n) {
          return n(function () {
            Pa(t) && Ba(e);
        ...
        function ic(e, t) {
          ...
          if (0 !== t) {
            if (
              ...
              throw ((n = Pl), fc(e, 0), lc(e, r), oc(e, qe()), n);
            if (6 === t) lc(e, r);
            else {
              if (
        ...
        function cc(e) {
          ...
          if (1 === n) throw ((n = Pl), fc(e, 0), lc(e, t), oc(e, qe()), n);
        ...
        function pc(e) {
          ...
          var n = Tl.transition,
            r = At;
          try {
            if (((Tl.transition = null), (At = 1), e)) return e();
          } finally {
            (At = r), (Tl.transition = n), 0 == (6 & (Il = t)) && Vo();
          }
        }
        function dc() {
          (Ll = jl.current), ko(jl);
        ...
        function Ec() {
          if (null !== Zl) {
            var e = bt(Xl),
              ...
              n = At;
            try {
              if (((Tl.transition = null), (At = 16 > e ? 16 : e), null === Zl))
                var r = !1;
              else {
              ...
              (At = n), (Tl.transition = t);
            }
          }
          return !1;
        }
        function wc(e, t, n) {
          (e = zi(e, (t = hs(0, (t = us(n, t)), 1)), 1)),
            (t = tc()),
        ...
        function kc(e, t, n) {
          ...
          null !== r && r.delete(t),
            ...
            Rl === e &&
              (Nl & n) === n &&
              (4 === zl ||
              (3 === zl && (130023424 & Nl) === Nl && 500 > qe() - Ul)
                ? fc(e, 0)
                : (Fl |= n)),
            oc(e, t);
        }
        ...
        function Wc(e, t, n, r) {
          ...
          return (
            ...
            null !== (e = zi(o, t, a)) && (rc(e, o, a, i), Pi(e, o, a)),
            a
          );
        }
        function Yc(e) {
        ...
        wl = function (e, t, n) {
          ...
          else (bs = !1), ii && 0 != (1048576 & t.flags) && ei(t, $o, t.index);
    ...
    (() => {
      ...
      function r(e) {
        const r = (function (e) {
            ...
            const o = r.components.raycaster,
              i = o.refreshObjects;
            (o.refreshObjects = () => {
              i.call(o);
              const e = o.objects;
              o.objects = e.filter((e) => {
                for (; e; ) {
            ...
            function l(t) {
              ...
              t.preventDefault();
              const r = n(e.container, t.clientX, t.clientY);
              a.fromArray(r);
            }
            function c(t) {
              if (t instanceof CustomEvent) return;
            ...
            function u(e) {
              const n = r.components.cursor.intersectedEl;
          ...
          o = e.sceneEl;
        o.addEventListener('camera-set-active', (t) => {
          e.opened && (e.cameras.original = t.detail.cameraEl);
        });
        const i = e.sceneHelpers,
        ...
        (u.size = 0.75),
          u.addEventListener('objectChange', (e) => {
            const n = u.object;
            if (void 0 === n) return;
            let r, o;
        ...
        p.center.set(0, 1.6, 0),
          ...
          t.A.on('cameratoggle', (e) => {
            p.setCamera(e.camera), u.setCamera(e.camera), f();
          }),
          d(),
          t.A.on('inspectorcleared', () => {
            p.center.set(0, 0, 0);
          }),
          t.A.on('transformmodechange', (e) => {
            u.setMode(e);
          }),
          t.A.on('translationsnapchanged', (e) => {
            u.setTranslationSnap(e);
          }),
          t.A.on('rotationsnapchanged', (e) => {
            u.setRotationSnap(e);
          }),
          t.A.on('transformspacechanged', (e) => {
            u.setSpace(e);
          }),
          t.A.on('objectselect', (e) => {
          ...
          t.A.on('objectfocus', (e) => {
            p.focus(e);
          }),
          t.A.on('geometrychanged', (e) => {
          ...
          t.A.on('gridvisibilitychanged', (e) => {
            a.visible = e;
          }),
          t.A.on('togglegrid', () => {
            a.visible = !a.visible;
          }),
          t.A.on('inspectortoggle', (t) => {
            t
              ? (d(),
      ...
      function s(e, t) {
        ...
        if (((n = Object.keys(e)), (r = Object.keys(t)), n.length !== r.length))
          return !1;
        for (var i = 0; i < n.length; i++) if (!s(e[n[i]], t[r[i]])) return !1;
        return !0;
      }
      function l(e, t) {
      ...
      function p(e) {
        ...
        n.addEventListener(
          'loaded',
          function () {
            AFRAME.INSPECTOR.selectEntity(n), t.A.emit('entityclone', n);
          },
          { once: !0 }
        ),
          e.id &&
          ...
          (r = n),
          (o = e).parentNode || (o = AFRAME.INSPECTOR.selectedEntity),
          o
            ? o.parentNode.insertBefore(r, o.nextSibling)
            : AFRAME.INSPECTOR.sceneEl.appendChild(r);
      }
      function d(e) {
        for (
                    ...
                    r = (
                      g(e.schema)
                        ? function () {
                            var r = f(e, null, t);
                            return (
                              void 0 === r && (r = h(e, null, t)),
                              void 0 !== r ? (n = !0) : (r = m(e, null)),
              ...
              if (p && null === d) n.call(e, i);
                ...
                var v =
                  ...
                  null === (l = void 0 === (l = d) ? {} : l)
                    ...
                    : (g(a)
                        ? function () {
                            return a.stringify(l);
                          }
                        : function () {
                            var e = {};
                            return (
                              Object.keys(l).forEach(function (t) {
                                a[t] && (e[t] = a[t].stringify(l[t]));
                              }),
      ...
      const A = {
        ...
        onKeyUp: function (e) {
          if (y(e) && AFRAME.INSPECTOR.opened) {
            var n = e.keyCode;
            if (
              ...
              (8 !== n && 46 !== n) ||
                (AFRAME.INSPECTOR.selectedEntity &&
                  u(AFRAME.INSPECTOR.selectedEntity, undefined)),
              68 === n &&
                AFRAME.INSPECTOR.selectedEntity &&
                p(AFRAME.INSPECTOR.selectedEntity),
              70 === n)
            ) {
              const e = AFRAME.INSPECTOR.selectedEntity;
              null != e && t.A.emit('objectfocus', e.object3D);
            }
            for (var r in (49 === n
            ...
            this.shortcuts.modules)) {
              var o = this.shortcuts.modules[r];
              o[n] &&
                (!o[n].mustBeActive ||
                  (o[n].mustBeActive && AFRAME.INSPECTOR.modules[r].active)) &&
                this.shortcuts.modules[r][n].callback();
            }
          }
        },
              ...
              (AFRAME.INSPECTOR.selectedEntity &&
                ...
                (67 === e.keyCode &&
                  (AFRAME.INSPECTOR.entityToCopy =
                    AFRAME.INSPECTOR.selectedEntity),
                86 === e.keyCode && p(AFRAME.INSPECTOR.entityToCopy)),
              83 === e.keyCode &&
                (e.preventDefault(),
                e.stopPropagation(),
      ...
      class _ extends b.Component {
        static propTypes = { icon: D().object.isRequired };
        render() {
          const {
            width: e,
            height: t,
            ...
            return (
              (o = Array.isArray(r)
                ? (0, F.jsx)('g', {
                    children: r.map((e, t) =>
                      (0, F.jsx)('path', { fill: 'currentColor', d: e }, t)
                    )
                  })
                : (0, F.jsx)('path', { fill: 'currentColor', d: r })),
      ...
      function Ie(e) {
        return (me = ge = 1), (ve = de((be = e))), (ye = 0), [];
      }
      function Re(e) {
        return (be = ''), e;
      }
      function Oe(e) {
        return se(Se(ye - 1, je(91 === e ? e + 2 : 40 === e ? e + 1 : e)));
      }
      function Ne(e) {
        for (; (Ae = Me()) && Ae < 33; ) we();
        return Te(e) > 2 || Te(Ae) > 3 ? '' : ' ';
      }
      function Le(e, t) {
        for (
          ;
        ...
        return Se(e, ke() + (t < 6 && 32 == Me() && 32 == we()));
      }
      function je(e) {
        for (; we(); )
          switch (Ae) {
      ...
      function ze(e, t) {
        for (; we() && e + Ae !== 57 && (e + Ae !== 84 || 47 !== Me()); );
        return '/*' + Se(t, ye - 1) + '*' + ie(47 === e ? e : we());
      }
      function Pe(e) {
        for (; !Te(Me()); ) we();
        return Se(e, ye);
      ...
      function Ye(e, t, n, r) {
        ...
        return de((n = We(e.children, r)))
          ? (e.return = e.value + '{' + n + '}')
          : '';
      }
      function Qe(e) {
        return Re($e('', null, null, null, [''], (e = Ie(e)), 0, [0], e));
      }
      function $e(e, t, n, r, o, i, a, s, l) {
        for (
          ...
          switch (((h = y), (y = we()))) {
            case 40:
              if (108 != h && 58 == ue(E, p - 1)) {
                -1 != ce((E += le(Oe(y), '&', '&\f')), '&\f') && (v = -1);
                break;
              }
            case 34:
            case 39:
            ...
            case 0:
              switch (y) {
                ...
                default:
                  if (
                    (he(
                      (x = Ge(E, t, n, c, u, o, s, A, (b = []), (C = []), p)),
                      i
                    ),
                    123 === y)
                  )
                    if (0 === u) $e(E, t, x, x, b, i, p, s, C);
                    else
                      switch (99 === d && 110 === ue(E, 3) ? 100 : d) {
                        case 100:
                        case 109:
                        case 115:
                          $e(
            ...
            default:
              if (m < 1)
                if (123 == y) --m;
                else if (125 == y && 0 == m++ && 125 == Ee()) continue;
              switch (((E += ie(y)), y * m)) {
                case 38:
                  v = u > 0 ? 1 : ((E += '\f'), -1);
                  break;
      ...
      function Ge(e, t, n, r, o, i, a, s, l, c, u) {
        for (
          var p = o - 1, d = 0 === o ? i : [''], f = fe(d), h = 0, m = 0, g = 0;
          h < r;
          ++h
        )
          for (
            var v = 0, y = pe(e, p + 1, (p = oe((m = a[h])))), A = e;
            v < f;
            ++v
          )
            (A = se(m > 0 ? d[v] + ' ' + y : le(y, /&\f/g, d[v]))) &&
              (l[g++] = A);
        return Ce(e, t, n, 0 === o ? He : s, l, c, u);
      }
      function Ze(e, t, n) {
        return Ce(e, t, n, _e, ie(Ae), pe(e, 2, -2), 0);
      }
      function Xe(e, t, n, r) {
        return Ce(e, t, n, Ue, pe(e, 0, r), pe(e, r + 1, -1), r);
      }
      var qe = function (e, t, n) {
          for (
            var r = 0, o = 0;
            (r = o), (o = Me()), 38 === r && 12 === o && (t[n] = 1), !Te(o);
        ...
        Je = function (e) {
          if ('rule' === e.type && e.parent && !(e.length < 1)) {
            ...
            if (
              (1 !== e.props.length || 58 === t.charCodeAt(0) || Ke.get(n)) &&
              !r
            ) {
              Ke.set(e, !0);
              for (
      ...
      function tt(e, t) {
        switch (
          ...
          case 6968:
          case 2756:
            return Fe + e + De + e + Be + e + e;
          case 6828:
          case 4268:
            return Fe + e + Be + e + e;
          case 6165:
            return Fe + e + Be + 'flex-' + e + e;
          case 5187:
            return (
              Fe +
              e +
              le(e, /(\w+).+(:[^]+)/, Fe + 'box-$1$2' + Be + 'flex-$1$2') +
              e
            );
          case 5443:
            return Fe + e + Be + 'flex-item-' + le(e, /flex-|-self/, '') + e;
          case 4675:
            return (
              Fe +
              e +
          ...
          case 5548:
            return Fe + e + Be + le(e, 'shrink', 'negative') + e;
          case 5292:
            return Fe + e + Be + le(e, 'basis', 'preferred-size') + e;
          case 6060:
            return (
              Fe +
              'box-' +
          ...
          case 4554:
            return Fe + le(e, /([^-])(transform)/g, '$1' + Fe + '$2') + e;
          case 6187:
            return (
              le(
                le(le(e, /(zoom-|grab)/, Fe + '$1'), /(image-set)/, Fe + '$1'),
                e,
                ''
              ) + e
            );
          ...
          case 4765:
            if (de(e) - 1 - t > 6)
              switch (ue(e, t + 1)) {
                ...
                case 115:
                  return ~ce(e, 'stretch')
                    ? tt(le(e, 'stretch', 'fill-available'), t) + e
                    : e;
              }
            break;
          case 4949:
            if (115 !== ue(e, t + 1)) break;
          case 6444:
            switch (ue(e, de(e) - 3 - (~ce(e, '!important') && 10))) {
              case 107:
                return le(e, ':', ':' + Fe) + e;
              case 101:
                return (
          ...
          case 5936:
            switch (ue(e, t + 11)) {
              case 114:
                return Fe + e + Be + le(e, /[svh]\w+-[tblr]{2}/, 'tb') + e;
              case 108:
                return Fe + e + Be + le(e, /[svh]\w+-[tblr]{2}/, 'tb-rl') + e;
              case 45:
                return Fe + e + Be + le(e, /[svh]\w+-[tblr]{2}/, 'lr') + e;
            }
            return Fe + e + Be + e + e;
        }
        return e;
      ...
      var nt = [
        function (e, t, n, r) {
          if (e.length > -1 && !e.return)
            switch (e.type) {
              case Ue:
                e.return = tt(e.value, e.length);
                break;
              case Ve:
                return We([xe(e, { value: le(e.value, '@', '@' + Fe) })], r);
              case He:
                if (e.length)
                  return (function (e, t) {
                    return e.map(t).join('');
                      ...
                      case '::placeholder':
                        return We(
                          [
                            xe(e, {
                              props: [
                                le(t, /:(plac\w+)/, ':' + Fe + 'input-$1')
                              ]
                            }),
                            xe(e, { props: [le(t, /:(plac\w+)/, ':-moz-$1')] }),
                            xe(e, {
                              props: [le(t, /:(plac\w+)/, Be + 'input-$1')]
                            })
                          ],
                          r
                        );
      ...
      var st = /[A-Z]|^ms/g,
        ...
        pt = (function (e) {
          ...
          return function (e) {
            return (
              void 0 === t[e] &&
                (t[e] = ct((n = e)) ? n : n.replace(st, '-$&').toLowerCase()),
              t[e]
            );
            var n;
          };
        ...
        dt = function (e, t) {
          ...
          return 1 === at[e] || ct(e) || 'number' != typeof t || 0 === t
            ? t
            : t + 'px';
        };
      function ft(e, t, n) {
      ...
      var ht,
        ...
        gt = function (e, t, n) {
          ...
          for (var a = 1; a < e.length; a++)
            (o += ft(n, t, e[a])), r && (o += i[a]);
          mt.lastIndex = 0;
          for (var s, l = ''; null !== (s = mt.exec(o)); ) l += '-' + s[1];
          return { name: it(o) + l, styles: o, next: ht };
        },
        vt =
      ...
      var bt = function (e) {
          return (0, b.forwardRef)(function (t, n) {
            var r = (0, b.useContext)(At);
            return e(t, r, n);
          });
        },
        Ct = (0, b.createContext)({}),
        xt = '__EMOTION_TYPE_PLEASE_DO_NOT_USE__',
        Et = function (e) {
          var t = e.cache,
            n = e.serialized,
            r = e.isStringTag;
        ...
        wt = bt(function (e, t, n) {
          ...
          var s = gt(i, void 0, (0, b.useContext)(Ct));
          a += t.key + '-' + s.name;
          var l = {};
          for (var c in e)
            yt.call(e, c) && 'css' !== c && c !== xt && (l[c] = e[c]);
          return (
            (l.ref = n),
            (l.className = a),
            (0, b.createElement)(
      ...
      var Mt = function (e, t) {
        ...
        (o[0] = wt),
          (o[1] = (function (e, t) {
            var n = {};
            for (var r in t) yt.call(t, r) && (n[r] = t[r]);
            return (n[xt] = e), n;
          })(e, t));
      ...
      function zt(e) {
        return (
          ...
          (e instanceof Tt(e).ShadowRoot || e instanceof ShadowRoot)
        );
      }
      function Pt(e) {
      ...
      function _t(e) {
        const t =
          !Lt(e) && e.contextElement ? e.contextElement : Lt(e) ? e : null;
        if (!t) return Ft;
        ...
        if ('border-box' !== r.boxSizing)
          return Nt(t)
            ? {
                x: (t.offsetWidth > 0 && Dt(n.width) / t.offsetWidth) || 1,
                y: (t.offsetHeight > 0 && Dt(n.height) / t.offsetHeight) || 1
              }
            : Ft;
      ...
      function Ht(e, t, n, r) {
        ...
        let c = Ft;
        t && (r ? Lt(r) && (c = _t(r)) : (c = _t(e)));
        const u = Lt(e) ? Tt(e) : window,
          p = !Bt() && n,
          d =
            (l.left +
              (p &&
      ...
      function Wt(e, t) {
        ...
        const r = Vt(e),
          ...
          i = Tt(r);
        return o
          ? t.concat(i, i.visualViewport || [], Pt(r) ? r : [])
          : t.concat(r, Wt(r));
      }
      const Yt = b.useLayoutEffect;
      var Qt = [
          'className',
          'clearValue',
          'cx',
      ...
      function Zt(e, t) {
        ...
        if (t && e)
          for (var a in t)
            t.hasOwnProperty(a) && t[a] && i.push(''.concat(Gt(e, a)));
        return i
          .filter(function (e) {
            return e;
          })
      ...
      function nn(e, t) {
        ...
        !(function t() {
          ...
          tn(e, l), a < n ? window.requestAnimationFrame(t) : r(e);
        })();
      }
      function rn(e, t) {
        ...
        r.bottom + o > n.bottom
          ...
          : r.top - o < n.top && tn(e, Math.max(t.offsetTop - o, 0));
      }
      function on() {
        try {
      ...
      ln.addEventListener &&
        ...
        (ln.addEventListener('p', $t, sn), ln.removeEventListener('p', $t, !1));
      var cn = an;
      function un(e) {
        return null != e;
      }
      ...
      var hn,
        ...
        An = function (e) {
          var t = e.children,
            ...
            s = e.theme,
            l = ((0, b.useContext)(yn) || {}).setPortalPlacement,
            c = (0, b.useRef)(null),
            u = G((0, b.useState)(r), 2),
            p = u[0],
            d = u[1],
            f = G((0, b.useState)(null), 2),
            h = f[0],
            m = f[1],
        ...
        Nn = (function () {
          ...
          hn ||
            ...
            gn || (gn = mn.slice(0)),
            (hn = Object.freeze(
              Object.defineProperties(mn, { raw: { value: Object.freeze(gn) } })
            )))
        ),
        Ln = function (e) {
          var t = e.delay,
        ...
        jn = ['data'],
        zn = ['innerRef', 'isDisabled', 'isHidden', 'inputClassName'],
        Pn = {
          gridArea: '1 / 2',
          font: 'inherit',
          minWidth: '2px',
        ...
        _n = {
          ...
          GroupHeading: function (e) {
            ...
            return Mt(
              'div',
              q({}, Kt(e, 'groupHeading', { 'group-heading': !0 }), n)
            );
          },
          IndicatorsContainer: function (e) {
            ...
            return Mt(
              'div',
              q({}, Kt(e, 'indicatorsContainer', { indicators: !0 }), n),
              t
            );
          },
          IndicatorSeparator: function (e) {
            ...
            return Mt(
              ...
              q(
                {},
                t,
                Kt(e, 'indicatorSeparator', { 'indicator-separator': !0 })
              )
            );
          },
          Input: function (e) {
            ...
            return Mt(
              'div',
              q({}, Kt(e, 'input', { 'input-container': !0 }), {
                'data-value': n || ''
              }),
              Mt(
                'input',
          ...
          LoadingIndicator: function (e) {
            ...
            return Mt(
              ...
              q(
                {},
                Kt(
                  Y(Y({}, i), {}, { innerProps: t, isRtl: n, size: o }),
                  'loadingIndicator',
                  { indicator: !0, 'loading-indicator': !0 }
                ),
                t
              ),
              Mt(Ln, { delay: 0, offset: n }),
              Mt(Ln, { delay: 160, offset: !0 }),
              Mt(Ln, { delay: 320, offset: !n })
            );
          },
          Menu: function (e) {
            var t = e.children,
            ...
            return Mt(
              ...
              Mt(
                c,
                {
                  ...
                  innerProps: Y(
                    {},
                    Kt(e, 'multiValueLabel', { 'multi-value__label': !0 })
                  ),
                  selectProps: s
                },
                t
              ...
              Mt(u, {
                ...
                innerProps: Y(
                  Y(
                    {},
                    Kt(e, 'multiValueRemove', { 'multi-value__remove': !0 })
                  ),
                  {},
          ...
          Placeholder: function (e) {
            ...
            return Mt(
              'div',
              q({}, Kt(e, 'placeholder', { placeholder: !0 }), n),
              t
            );
          },
          SelectContainer: function (e) {
            ...
            return Mt(
              ...
              q(
                {},
                Kt(e, 'container', { '--is-disabled': r, '--is-rtl': o }),
                n
              ),
              t
            );
      ...
      function Un(e, t) {
        ...
        for (var n = 0; n < e.length; n++)
          if (!((r = e[n]) === (o = t[n]) || (Hn(r) && Hn(o)))) return !1;
        var r, o;
        return !0;
      }
      for (
          ...
          Qn = function (e) {
            var t = e.ariaSelection,
              ...
              S = (0, b.useMemo)(
                function () {
                  var e = '';
                  if (g && v.length && !C && w.onFilter) {
                    var t = y({ count: o.length });
                    e = w.onFilter({ inputValue: d, resultsMessage: t });
                  }
                  return e;
                },
                [o, d, g, w, v, y, C]
              ...
              I = (0, b.useMemo)(
                ...
                [x, n, r, f, h, m, g, w, a, A, T]
              ),
              R = Mt(
                b.Fragment,
                null,
                Mt('span', { id: 'aria-selection' }, M),
                Mt('span', { id: 'aria-focused' }, k),
                Mt('span', { id: 'aria-results' }, S),
                Mt('span', { id: 'aria-guidance' }, I)
              );
            return Mt(
              b.Fragment,
              null,
        ...
        for (var qn = $n[Xn], Kn = 0; Kn < qn.letters.length; Kn++)
          Zn[qn.letters[Kn]] = qn.base;
      var Jn = function (e) {
      ...
      function or(e) {
        var t = e.innerRef,
          ...
          })(Z(e, rr), 'onExited', 'in', 'enter', 'exit', 'appear');
        return Mt(
          'input',
          q({ ref: t }, n, {
            css: kt(
      ...
      var ir = ['boxSizing', 'height', 'overflow', 'paddingRight', 'position'],
        ar = {
              ...
              a = (0, b.useCallback)(
                function (e) {
                  if (pr) {
                    ...
                    t &&
                      ur() &&
                      (t.addEventListener('touchmove', sr, fr),
                      e &&
                        (e.addEventListener('touchstart', cr, fr),
                        e.addEventListener('touchmove', lr, fr))),
                      (dr += 1);
                  }
                },
                [r]
                ...
                function (e) {
                  if (pr) {
                    ...
                    (dr = Math.max(dr - 1, 0)),
                      ...
                      t &&
                        ur() &&
                        (t.removeEventListener('touchmove', sr, fr),
                        e &&
                          (e.removeEventListener('touchstart', cr, fr),
                          e.removeEventListener('touchmove', lr, fr)));
                  }
                },
                [r]
              );
      ...
      function Tr(e, t) {
        var n = e.inputValue,
          ...
          a = t.label,
          s = t.value;
        return (!zr(e) || !i) && jr(e, { label: a, value: s, data: o }, r);
      }
      var Ir = function (e, t) {
          var n;
          return (
            ...
            if (
              ...
              (r.selectOption = function (e) {
                ...
                if (s) {
                  ...
                  o
                    ? r.setValue([].concat(ne(a), [e]), 'select-option', e)
              ...
              (r.getFocusedOptionId = function (e) {
                return Ir(r.state.focusableOptionsWithIds, e);
              }),
              (r.getFocusableOptionsWithIds = function () {
                return Sr(
                  Mr(r.props, r.state.selectValue),
              ...
              (r.cx = function () {
                for (
                  ...
                  t[n] = arguments[n];
                return Zt.apply(void 0, [r.props.classNamePrefix].concat(t));
              }),
              ...
              (r.getComponents = function () {
                return (e = r.props), Y(Y({}, _n), e.components);
                var e;
              }),
              (r.buildCategorizedOptions = function () {
                return Mr(r.props, r.state.selectValue);
              }),
              (r.getCategorizedOptions = function () {
                return r.props.menuIsOpen ? r.buildCategorizedOptions() : [];
              }),
              (r.buildFocusableOptions = function () {
                return kr(r.buildCategorizedOptions());
              }),
              (r.getFocusableOptions = function () {
                return r.props.menuIsOpen ? r.buildFocusableOptions() : [];
              }),
              (r.ariaOnChange = function (e, t) {
                r.setState({ ariaSelection: Y({ value: e }, t) });
              }),
              ...
              (r.state.instancePrefix =
                'react-select-' + (r.props.instanceId || ++Pr)),
              (r.state.selectValue = Xt(e.value)),
              ...
              (r.state.focusableOptionsWithIds = o),
                ...
                (r.state.focusedOptionId = Ir(o, i[a]));
            }
            return r;
          }
          return (
              ...
              [
                  ...
                  value: function () {
                    this.startListeningComposition(),
                      ...
                      this.props.menuIsOpen &&
                        ...
                        rn(this.menuListRef, this.focusedOptionRef);
                  }
                },
                {
                ...
                },
                {
                  ...
                  value: function () {
                    ...
                    return b.createElement(
                      e,
                      q({}, t, { innerProps: o, isDisabled: n, isFocused: r })
                    );
                  }
                },
                {
                  ...
                  value: function () {
                    ...
                    if (this.hasOptions())
                      ...
                      var O = g({ inputValue: h });
                      if (null === O) return null;
                      I = b.createElement(s, u, O);
                    } else {
                      var N = k({ inputValue: h });
                      if (null === N) return null;
                      I = b.createElement(l, u, N);
                    }
                    var L = {
                        minMenuHeight: v,
                        maxMenuHeight: y,
                      ...
                      j = b.createElement(An, q({}, u, L), function (t) {
                        var n = t.ref,
                          r = t.placerProps,
                          a = r.placement,
                          s = r.maxHeight;
                  ...
                  value: function () {
                    ...
                    if (i && !r) {
                      if (o) {
                        ...
                        return b.createElement('div', null, c);
                      }
      ...
      Br.defaultProps = Er;
      var Dr = (0, b.forwardRef)(function (e, t) {
          var n = (function (e) {
            var t = e.defaultInputValue,
              ...
              f = e.value,
              h = Z(e, X),
              m = G((0, b.useState)(void 0 !== s ? s : n), 2),
              g = m[0],
              v = m[1],
              y = G((0, b.useState)(void 0 !== l ? l : o), 2),
              A = y[0],
              C = y[1],
              x = G((0, b.useState)(void 0 !== f ? f : a), 2),
              E = x[0],
              w = x[1],
              M = (0, b.useCallback)(
                function (e, t) {
          ...
          return b.createElement(Br, q({ ref: t }, n));
        }),
        Fr = Dr;
      class _r extends b.Component {
        static propTypes = { entity: D().object };
        addComponent = (e) => {
          let n = e.value;
          var r = this.props.entity;
          if (AFRAME.components[n].multiple) {
            const e = prompt(
              `Provide an ID for this component (e.g., 'foo' for ${n}__foo).`
            );
            n = e ? `${n}__${e}` : n;
          }
          r.setAttribute(n, ''),
            t.A.emit('componentadd', { entity: r, component: n });
        };
      ...
      function Hr(e) {
        ...
        if ('string' == typeof e || 'number' == typeof e) r += e;
          ...
          if (Array.isArray(e)) {
            var o = e.length;
            for (t = 0; t < o; t++)
              e[t] && (n = Hr(e[t])) && (r && (r += ' '), (r += n));
          } else for (n in e) e[n] && (r && (r += ' '), (r += n));
        return r;
      }
      const Ur = function () {
        for (var e, t, n = 0, r = '', o = arguments.length; n < o; n++)
          (e = arguments[n]) && (t = Hr(e)) && (r && (r += ' '), (r += t));
        return r;
      };
      class Vr extends b.Component {
        static propTypes = {
      ...
      class Gr extends b.Component {
        ...
        openDialog = () => {
          t.A.emit('opentexturesmodal', this.state.value, (e) => {
            if (e) {
              var t = e.value;
              'asset' !== e.type &&
                (t =
      ...
      class Zr extends b.Component {
        ...
        render() {
          ...
          return (0, F.jsxs)('div', {
            className: 'vec4',
            children: [
              (0, F.jsx)(Qr, { name: 'x', value: this.state.x, ...e }),
              (0, F.jsx)(Qr, { name: 'y', value: this.state.y, ...e }),
              (0, F.jsx)(Qr, { name: 'z', value: this.state.z, ...e }),
              (0, F.jsx)(Qr, { name: 'w', value: this.state.w, ...e })
            ]
          });
        }
      }
      class Xr extends b.Component {
        static propTypes = {
          componentname: D().string,
          entity: D().object,
          onChange: D().func,
      ...
      class Kr extends b.Component {
        ...
        getWidget() {
          ...
          const o =
            ...
            i = {
              ...
              onChange: function (n, r) {
                ...
                })(e.entity, e.componentname, e.isSingle ? '' : e.name, r);
              },
              value: o
            },
            a = {
          ...
          if (e.schema.oneOf && e.schema.oneOf.length > 0)
            return (0, F.jsx)($r, { ...i, options: e.schema.oneOf });
          if ('map' === r || n) return (0, F.jsx)(Gr, { ...i });
          switch (r) {
            case 'number':
              return (0, F.jsx)(Qr, { ...i, ...a });
            case 'int':
              return (0, F.jsx)(Qr, { ...i, ...a, precision: 0 });
            case 'vec2':
              return (0, F.jsx)(qr, { ...i });
            case 'vec3':
              return (0, F.jsx)(Xr, { ...i });
      ...
      class Jr extends b.Component {
        ...
        render() {
          ...
          const t = Ur(e),
            n = Ur({ content: !0, hide: this.state.collapsed });
          return (0, F.jsxs)('div', {
            id: this.props.id,
            className: t,
            children: [
      ...
      var eo = o(673),
        to = o.n(eo);
      const no = AFRAME.schema.isSingleProperty;
      class ro extends b.Component {
        static propTypes = {
          component: D().any,
          entity: D().object,
          isCollapsed: D().bool,
        ...
        removeComponent = (e) => {
          ...
          e.stopPropagation(),
            confirm('Do you really want to remove component `' + n + '`?') &&
              (this.props.entity.removeAttribute(n),
                    ...
                    (0, F.jsxs)('div', {
                      ...
                      children: [
                        (0, F.jsx)('a', {
                          ...
                          children: (0, F.jsx)(_, { icon: M })
                        }),
                        (0, F.jsx)('a', {
                          title: 'Remove component',
                          className: 'button',
                          onClick: this.removeComponent,
                          children: (0, F.jsx)(_, { icon: x })
                        })
                      ]
                    })
                  ]
      ...
      const oo = ['visible', 'position', 'scale', 'rotation'];
      class io extends b.Component {
        static propTypes = { entity: D().object.isRequired };
        constructor(e) {
        ...
        updateMixins = (e) => {
          const n = this.props.entity;
          this.setState({ mixins: e });
          const r = e.map((e) => e.value).join(' ');
          n.setAttribute('mixin', r),
            t.A.emit('entityupdate', {
              component: 'mixin',
              entity: n,
              property: '',
        ...
        render() {
          return (0, F.jsx)('div', {
            ...
            children: (0, F.jsxs)('div', {
              ...
              children: [
                (0, F.jsx)('span', { className: 'text', children: 'mixins' }),
                (0, F.jsx)('span', {
      ...
      class so extends b.Component {
        static propTypes = { entity: D().object, onDoubleClick: D().func };
        render() {
          ...
          for (let t in ao)
            e.getObject3D(t) &&
              n.push((0, F.jsxs)('span', { children: [' ', ao[t]] }, t));
          let r = e.id,
            o = 'id';
          return (
            ...
            (0, F.jsxs)('span', {
              ...
              children: [
                ...
                n.length > 0 &&
                  (0, F.jsx)('span', { className: 'entityIcons', children: n }),
                (0, F.jsx)('span', {
      ...
      class uo extends b.Component {
        static propTypes = { entity: D().object };
        onEntityUpdate = (e) => {
          e.entity === this.props.entity &&
            ((-1 === oo.indexOf(e.component) && 'mixin' !== e.component) ||
              this.forceUpdate());
        };
        componentDidMount() {
          t.A.on('entityupdate', this.onEntityUpdate);
        ...
        render() {
          const e = this.props.entity;
          if (!e) return (0, F.jsx)('div', {});
          const t = (0, F.jsxs)('div', {
            children: [
              (0, F.jsx)('a', {
          ...
          return (0, F.jsxs)(Jr, {
            ...
            children: [
              (0, F.jsxs)('div', {
                ...
                children: [(0, F.jsx)(so, { entity: e }), t]
              }),
              (0, F.jsxs)('div', {
                className: 'collapsible-content',
                children: [
                  ...
                  (0, F.jsxs)('div', {
                    ...
                    children: [
                      ...
                      (0, F.jsx)('span', { children: e.getAttribute('class') })
                    ]
                  }),
      ...
      class fo extends b.Component {
        static propTypes = { entity: D().object, visible: D().bool };
        onComponentRemove = (e) => {
      ...
      class vo extends b.Component {
        ...
        constructor(e) {
          super(e),
            ...
            (this.imageName = b.createRef()),
            (this.preview = b.createRef()),
            (this.registryGallery = b.createRef());
        }
        ...
        isValidAsset() {
          let e = go(this.state.preview.name);
                  ...
                  children: [
                    ...
                    (0, F.jsxs)('div', {
                      ...
                      children: [
                        ...
                        (0, F.jsx)('span', { children: mo(e.src) }),
                        (0, F.jsxs)('span', {
                          ...
                          children: [
                            ...
                            (0, F.jsxs)('div', {
                              ...
                              children: [
                                ...
                                ' ',
                                (0, F.jsx)('span', { children: mo(t.src) }),
                                (0, F.jsxs)('span', {
      ...
      class yo extends b.Component {
        static propTypes = { isOpen: D().bool, onClose: D().func };
        constructor(e) {
      ...
      class Co extends b.Component {
        ...
        onDoubleClick = () =>
          t.A.emit('objectfocus', this.props.entity.object3D);
        toggleVisibility = () => {
          const e = this.props.entity,
            t =
      ...
      class Eo extends b.Component {
        constructor(e) {
          super(e), (this.state = { isPlaying: !1 });
        }
        exportSceneToGLTF() {
          const e =
              AFRAME.scenes[0].id ||
        ...
        addEntity() {
          t.A.emit('entitycreate', { element: 'a-entity', components: {} });
        }
        writeChanges = () => {
      ...
      class wo extends b.Component {
        ...
        constructor(e) {
          super(e),
            ...
            (this.updateFilteredEntities = bo()(
        ...
        selectEntity = (e) => {
          let n = !1;
          for (let r = 0; r < this.state.filteredEntities.length; r++)
            this.state.filteredEntities[r].entity === e &&
              (this.setState({ selectedIndex: r }),
              setTimeout(() => {
                document
                  .getElementById('sgnode' + r)
                  ?.scrollIntoView({ behavior: 'smooth' });
              }, 500),
              this.expandToRoot(e),
              t.A.emit('entityselect', e),
              (n = !0));
          n || this.setState({ selectedIndex: -1 });
        };
                ...
                children: [
                  ...
                  (0, F.jsxs)('div', {
                    ...
                    children: [
                      ...
                      e,
                      !this.state.filter && (0, F.jsx)(_, { icon: L })
                    ]
                  })
                ]
              }),
      ...
      var So = [
        { value: 'translate', icon: (0, F.jsx)(_, { icon: T }) },
        {
          value: 'rotate',
          icon: (0, F.jsx)(_, {
            icon: {
      ...
      class To extends b.Component {
        ...
        componentWillUnmount() {
          t.A.off('transformmodechange', this.onTransformModeChange),
            t.A.off('transformspacechange', this.onTransformSpaceChange);
        }
      ...
      class Io extends b.Component {
        ...
        render() {
          return (0, F.jsx)('div', {
            id: 'viewportHud',
            children: (0, F.jsx)('p', {
              children: (0, F.jsx)(so, { entity: this.state.hoveredEntity })
            })
          });
        }
      }
      ...
      class Ro extends b.Component {
        ...
        componentDidMount() {
          t.A.on(
            ...
            t.A.on('entityselect', (e) => {
              this.setState({ entity: e });
            }),
            t.A.on('inspectortoggle', (e) => {
              this.setState({ inspectorEnabled: e });
            }),
            t.A.on('openhelpmodal', () => {
      ...
      const jo = THREE;
      let zo, Po, Bo, Do;
      function Fo(e, t = 1 / 0, n = null) {
        Po || (Po = new jo.PlaneGeometry(2, 2, 1, 1)),
          Bo ||
            (Bo = new jo.ShaderMaterial({
              uniforms: { blitTexture: new jo.Uniform(e) },
              vertexShader:
                '\n\t\t\tvarying vec2 vUv;\n\t\t\tvoid main(){\n\t\t\t\tvUv = uv;\n\t\t\t\tgl_Position = vec4(position.xy * 1.0,0.,.999999);\n\t\t\t}',
              fragmentShader:
                '\n\t\t\tuniform sampler2D blitTexture; \n\t\t\tvarying vec2 vUv;\n\n\t\t\tvoid main(){ \n\t\t\t\tgl_FragColor = vec4(vUv.xy, 0, 1);\n\t\t\t\t\n\t\t\t\t#ifdef IS_SRGB\n\t\t\t\tgl_FragColor = sRGBTransferOETF( texture2D( blitTexture, vUv) );\n\t\t\t\t#else\n\t\t\t\tgl_FragColor = texture2D( blitTexture, vUv);\n\t\t\t\t#endif\n\t\t\t}'
            })),
          (Bo.uniforms.blitTexture.value = e),
          (Bo.defines.IS_SRGB = e.colorSpace == jo.SRGBColorSpace),
          (Bo.needsUpdate = !0),
          Do || ((Do = new jo.Mesh(Po, Bo)), (Do.frustumCulled = !1));
        const r = new jo.PerspectiveCamera(),
          o = new jo.Scene();
        o.add(Do),
          null === n && (n = zo = new jo.WebGLRenderer({ antialias: !1 }));
        ...
        const c = new jo.CanvasTexture(s);
        return (
          ...
          (c.wrapT = e.wrapT),
          (c.name = e.name),
          zo && (zo.forceContextLoss(), zo.dispose(), (zo = null)),
          c
        );
      }
      const _o = {
      ...
      const Uo = 5120,
        ...
        Go = {};
      (Go[jo.NearestFilter] = 9728),
        (Go[jo.NearestMipmapNearestFilter] = 9984),
        (Go[jo.NearestMipmapLinearFilter] = 9986),
        (Go[jo.LinearFilter] = 9729),
        (Go[jo.LinearMipmapNearestFilter] = 9985),
        (Go[jo.LinearMipmapLinearFilter] = 9987),
        (Go[jo.ClampToEdgeWrapping] = 33071),
        (Go[jo.RepeatWrapping] = 10497),
        (Go[jo.MirroredRepeatWrapping] = 33648);
      const Zo = {
          scale: 'scale',
      ...
      class ni {
        constructor() {
          (this.plugins = []),
            ...
            (this.json = {
              asset: {
                version: '2.0',
                generator: 'THREE.GLTFExporter r' + jo.REVISION
              }
            }),
            (this.cache = {
              meshes: new Map(),
        ...
        buildMetalRoughTexture(e, t) {
          if (e === t) return e;
          function n(e) {
            return e.colorSpace === jo.SRGBColorSpace
              ? function (e) {
                  return e < 0.04045
                    ? 0.0773993808 * e
          ...
          console.warn(
            ...
            e instanceof jo.CompressedTexture && (e = Fo(e)),
            t instanceof jo.CompressedTexture && (t = Fo(t));
          ...
          const u = (e || t).clone();
          return (
            (u.source = new jo.Source(s)),
            (u.colorSpace = jo.NoColorSpace),
                ...
                : (0 === n
                    ...
                    : 1 === n
                      ...
                      : 2 === n
                        ...
                        : 3 === n && (r = e.getW(o)),
                  !0 === e.normalized &&
                    (r = jo.MathUtils.normalize(r, e.array))),
                5126 === t
                  ? c.setFloat32(u, r, !0)
                  : 5124 === t
                    ? c.setInt32(u, r, !0)
        ...
        processAccessor(e, t, n, r) {
          ...
          else if (e.array.constructor === Int16Array) i = Wo;
          else if (e.array.constructor === Uint16Array) i = Yo;
          else if (e.array.constructor === Int8Array) i = Uo;
          else {
                  ...
                  : (0 === t
                      ...
                      : 1 === t
                        ...
                        : 2 === t
                          ...
                          : 3 === t && (n = e.getW(o)),
                    !0 === e.normalized &&
                      (n = jo.MathUtils.normalize(n, e.array))),
        ...
        processSampler(e) {
          ...
          const n = {
            magFilter: Go[e.magFilter],
            minFilter: Go[e.minFilter],
            wrapS: Go[e.wrapS],
            wrapT: Go[e.wrapT]
          };
        ...
        processTexture(e) {
          ...
          r.textures || (r.textures = []),
            e instanceof jo.CompressedTexture && (e = Fo(e, t.maxTextureSize));
        ...
        processMaterial(e) {
          ...
          e.transparent
            ...
            e.side === jo.DoubleSide && (r.doubleSided = !0),
        ...
        detectMeshQuantization(e, t) {
          if (this.extensionsUsed[$o]) return;
          let n;
          ...
          _o[r] &&
            _o[r].includes(n) &&
            ((this.extensionsUsed[$o] = !0),
            (this.extensionsRequired[$o] = !0));
        }
        processCamera(e) {
          const t = this.json;
          t.cameras || (t.cameras = []);
          ...
          return (
            n
              ...
              : (r.perspective = {
                  ...
                  yfov: jo.MathUtils.degToRad(e.fov),
                  zfar: e.far <= 0 ? 0.001 : e.far,
                  znear: e.near < 0 ? 0 : e.near
                }),
        ...
        processAnimation(e, t) {
          ...
          const o = (e = Ho.Utils.mergeMorphTargetTracks(e.clone(), t)).tracks,
            i = [],
            a = [];
          for (let e = 0; e < o.length; ++e) {
            const n = o[e],
              s = jo.PropertyBinding.parseTrackName(n.name);
            let l = jo.PropertyBinding.findNode(t, s.nodeName);
            const c = Zo[s.propertyName];
            if (
              ('bones' === s.objectName &&
                (l =
                  !0 === l.isSkinnedMesh
            ...
            c === Zo.morphTargetInfluences &&
              (d /= l.morphTargetInfluences.length),
              !0 ===
              n.createInterpolant.isInterpolantFactoryMethodGLTFCubicSpline
                ? ((p = 'CUBICSPLINE'), (d /= 3))
                : (p =
                    n.getInterpolation() === jo.InterpolateDiscrete
                      ? 'STEP'
                      : 'LINEAR'),
              a.push({
                input: this.processAccessor(new jo.BufferAttribute(n.times, u)),
                output: this.processAccessor(
                  new jo.BufferAttribute(n.values, d)
                ),
                interpolation: p
              }),
              i.push({
        ...
        processNode(e) {
          ...
          if (n.trs) {
            const t = e.quaternion.toArray(),
              ...
              r = e.scale.toArray();
            qo(t, [0, 0, 0, 1]) || (o.rotation = t),
              qo(n, [0, 0, 0]) || (o.translation = n),
              qo(r, [1, 1, 1]) || (o.scale = r);
          } else
        ...
        processInput(e) {
          ...
          for (let t = 0; t < e.length; t++)
            e[t] instanceof jo.Scene ? this.processScene(e[t]) : n.push(e[t]);
        ...
        writeNode(e, t) {
          ...
          for (let e = 0; e < r.count; e++)
            r.getMatrixAt(e, s),
              ...
              u.toArray(a, 3 * e);
          const p = {
            TRANSLATION: n.processAccessor(new jo.BufferAttribute(o, 3)),
            ROTATION: n.processAccessor(new jo.BufferAttribute(i, 4)),
            SCALE: n.processAccessor(new jo.BufferAttribute(a, 3))
          };
      ...
      Ho.Utils = {
        ...
        mergeMorphTargetTracks: function (e, t) {
          ...
          for (let e = 0; e < o.length; ++e) {
            let i = o[e];
            const a = jo.PropertyBinding.parseTrackName(i.name),
              s = jo.PropertyBinding.findNode(t, a.nodeName);
            if (
            ...
            if (
              ...
              console.warn(
                ...
                (i = i.clone()),
                i.setInterpolation(jo.InterpolateLinear);
            }
      ...
      (Ri.styleTagTransform = Ti()),
        (Ri.setAttributes = wi()),
        (Ri.insert = xi().bind(null, 'head')),
        (Ri.domAPI = bi()),
        (Ri.insertStyleElement = ki()),
        yi()(Ii.A, Ri),
        ...
        (Oi.prototype = {
              ...
              ? ((this.container = document.querySelector('.a-canvas')),
                (function (e) {
                  ...
                  (o.far = 1e4),
                    ...
                    n.object3D.add(o),
                    (n.camera = o);
                  const i = n.canvas.width / n.canvas.height,
                  ...
                  t.A.on('cameraperspectivetoggle', () => {
                    Lo(e.camera, Oo),
                    ...
                    t.A.on('cameraorthographictoggle', (r) => {
                      Lo(e.camera, Oo),
          ...
          initUI: function () {
            A.init(this), this.initEvents(), (this.selected = null);
            const t = document.createElement('div');
            (t.id = 'aframeInspector'),
              t.setAttribute('data-aframe-inspector', 'app'),
              document.body.appendChild(t),
              (0, e.H)(t).render((0, F.jsx)(Ro, {})),
          ...
          removeHelpers: function (e) {
            e.traverse((e) => {
              const n = this.helpers[e.uuid];
              n &&
                (this.sceneHelpers.remove(n),
                n.dispose(),
                delete this.helpers[e.uuid],
                t.A.emit('helperremove', this.helpers[e.uuid]));
            });
          },
          ...
          initEvents: function () {
            window.addEventListener('keydown', (e) => {
              ...
              t.A.on('entitycreate', (e) => {
                !(function (e, n) {
                  const r = document.createElement(e.element || 'a-entity');
                  e.id && (r.id = e.id),
                    e.class && r.setAttribute('class', e.class);
                  for (let t in e.components)
                    r.setAttribute(t, e.components[t]);
                  r.addEventListener(
                    'loaded',
                    () => {
                      t.A.emit('entitycreated', r), n(r);
                    },
                    { once: !0 }
                  ),
                    AFRAME.scenes[0].appendChild(r);
                })(e, (e) => {
                  this.selectEntity(e);
                });
              }),
